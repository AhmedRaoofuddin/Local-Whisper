...
export const l10n = {
  en: {
    ...
    recommendedDownload: 'Recommended Downloads',
    ...
    clearHistoryMessage: 'Are you sure you want to clear all chat records? This action cannot be undone.',
    clearHistorySuccess: 'Chat history has been cleared',
    clearHistoryError: 'An error occurred while clearing history',
    enableFlashAttentionToChangeCache: 'Enable flash attention to change cache type',
    cpuThreadCount: 'CPU Thread Count',
    cpuThreadCountDescription: 'Using {{count}} available threads',
    flashAttention: 'Flash Attention',
    flashAttentionDescription: 'Enable flash attention to speed up processing',
    keyCacheType: 'Key Cache Type',
    keyCacheTypeDescription: 'Select cache type for key calculation',
    valueCacheType: 'Value Cache Type',
    valueCacheTypeDescription: 'Select cache type for value calculation',
    // modelSettings
  ...
  zh: {
      ...
      clearHistoryMessage: '确定要清空所有聊天记录吗？此操作不可撤销。',
      clearHistorySuccess: '聊天历史已清空',
      clearHistoryError: '清空历史时发生错误',
      enableFlashAttentionToChangeCache: '启用闪存注意力以更改缓存类型',
      cacheTypeF32: '浮点32位',
      cacheTypeF16: '浮点16位',
      cacheTypeQ8_0: '整数8位',
      cacheTypeQ5_1: '整数5.1位',
      cacheTypeQ5_0: '整数5位',
      cacheTypeQ4_1: '整数4.1位',
      cacheTypeQ4_0: '整数4位',
      cacheTypeIQ4_NL: '智能整数4位',
      cpuThreadCount: 'CPU 线程数',
      cpuThreadCountDescription: '使用 {{count}} 个可用线程',
      flashAttention: '闪存注意力',
      flashAttentionDescription: '启用闪存注意力以加速处理',
      keyCacheType: '键缓存类型',
